...
/**
 * @param {string} type - 프로필 이미지 타입 (profile, kakao, facebook, naver)
 * @param {string} size - [prifile 타입만 해당] 프로필 이미지 사이즈 (px, rem, %)
 * @param {string} imageUrl - [prifile 타입만 해당] 프로필 이미지 url
 */
export const CircleImage = ({
  type = "profile",
  size = "70px",
  imageUrl = "https://image.ohou.se/i/bucketplace-v2-development/uploads/users/profile_images/1689916282_naver_f33c08c20b06c9cb1451a01a8a2c5fa83fe135b6b25cec652fa8a06382c0a934.jpg?gif=1&w=144&h=144&c=c&webp=1",
}) => {
  return (
    <>
      {type === "profile" && (
